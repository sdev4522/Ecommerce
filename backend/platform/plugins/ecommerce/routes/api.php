...
use Botble\Ecommerce\Http\Controllers\API\OrderPlacementController;
...
Route::group([
    ...
    Route::post('orders/create', [OrderPlacementController::class, 'store']);
    Route::post('checkout/calculate', [OrderPlacementController::class, 'calculateCheckout']);
    Route::get('shipping-rules', [OrderPlacementController::class, 'getShippingRules']);
